$(document).ready(function () {
    ...
    }); $('.scroll-up-btn').click(function () { $('html').animate({ scrollTop: 0 }); $('html').css("scrollBehavior", "auto"); });
    ...
    var typed = new Typed(".typing", {
        strings: ["YouTuber",
            ...
            "Blogger",
            "Designer",
            "Freelancer"], typeSpeed: 100, backSpeed: 60, loop: true
    });
    ...
    $('.carousel').owlCarousel({ margin: 20, loop: true, autoplay: true, 
